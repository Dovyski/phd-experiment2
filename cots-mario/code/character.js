...
Mario.Character = function() {
    ...
    this.MoveSpeedWalk = 0.60;
    this.MoveSpeedRun = 0.90;
...
Mario.Character.prototype.GetHurt = function(byWho) {
    if (this.DeathTime > 0 || this.World.Paused) {
        return;
    }
    if (this.InvulnerableTime > 0) {
    ...
    if (this.Large) {
        ...
        if (this.Fire) {
            ...
            GlobalInfo.data.log({a: 'mario_powerdown', t: 'fire'}, true);
        } else {
            this.SetLarge(false, false);
            GlobalInfo.data.log({a: 'mario_powerdown', t: 'large'}, true);
        }
...
Mario.Character.prototype.GetFlower = function() {
    ...
    GlobalInfo.data.log({a: 'mario_powerup', t: 'flower'}, true);
};
...
Mario.Character.prototype.GetMushroom = function() {
    ...
    GlobalInfo.data.log({a: 'mario_powerup', t: 'mushroom'}, true);
};
...
Mario.Character.prototype.Get1Up = function() {
    ...
    GlobalInfo.data.log({a: 'mario_1up'}, true);
};
