...
Mario.MapState.prototype.CheckForChange = function(context) {
    ...
    if(GlobalInfo.experiment) {
        ...
        context.ChangeState(new Mario.LevelState(Experiment.config('levelDifficulty'), Mario.LevelType.Overground, Experiment.config('seed'), Experiment.config('levelWidth')));
    }
